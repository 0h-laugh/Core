...
/* Assigns pos for every elem in stack from top to bottom in ascending order */
...
/* Looks for best target pos in stack_a for given index of elem in stack_b */
...
/* Assigns target pos in stack_a for it's every elem for cost calculation */
